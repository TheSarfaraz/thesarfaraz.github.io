...
![png](files/Learn-Together-with-Sarfaraz_files/Learn-Together-with-Sarfaraz_18_0.png)
...
![png](files/Learn-Together-with-Sarfaraz_files/Learn-Together-with-Sarfaraz_19_0.png)
...
![png](files/Learn-Together-with-Sarfaraz_files/Learn-Together-with-Sarfaraz_26_0.png)
...
![png](files/Learn-Together-with-Sarfaraz_files/Learn-Together-with-Sarfaraz_28_1.png)
...
![png](files/Learn-Together-with-Sarfaraz_files/Learn-Together-with-Sarfaraz_30_0.png)
...
![png](files/Learn-Together-with-Sarfaraz_files/Learn-Together-with-Sarfaraz_34_0.png)
...
model_CV = GridSearchCV(estimator = model, param_grid = grid_params, verbose = 10)

model_CV.fit(train, y, **fit_params)
...
```
    ...
    /usr/local/lib/python3.6/dist-packages/sklearn/model_selection/_validation.py:530: FutureWarning:
    ...
    <ipython-input-43-f3b6466f9872> in <module>()
         17 model_CV = GridSearchCV(estimator = model, param_grid = grid_params, verbose = 10)
         18
    ---> 19 model_CV.fit(train, y, **fit_params)
         20
         21 model_CV.best_params_
    ...
    /usr/local/lib/python3.6/dist-packages/xgboost/sklearn.py in <genexpr>(.0)
        709                         missing=self.missing, weight=sample_weight_eval_set[i],
        710                         nthread=self.n_jobs)
    --> 711                 for i in range(len(eval_set))
        712             )
    ...
    /usr/local/lib/python3.6/dist-packages/xgboost/core.py in __init__(self, data, label, missing, weight, silent, feature_names, feature_types, nthread)
    ...
    ValueError: DataFrame.dtypes for data must be int, float or bool.
                    Did not expect the data types in fields Wilderness_Area1, Wilderness_Area2, Wilderness_Area3, Wilderness_Area4, Soil_Type1, Soil_Type2, Soil_Type3, Soil_Type4, Soil_Type5, Soil_Type6, Soil_Type7, Soil_Type8, Soil_Type9, Soil_Type10, Soil_Type11, Soil_Type12, Soil_Type13, Soil_Type14, Soil_Type15, Soil_Type16, Soil_Type17, Soil_Type18, Soil_Type19, Soil_Type20, Soil_Type21, Soil_Type22, Soil_Type23, Soil_Type24, Soil_Type25, Soil_Type26, Soil_Type27, Soil_Type28, Soil_Type29, Soil_Type30, Soil_Type31, Soil_Type32, Soil_Type33, Soil_Type34, Soil_Type35, Soil_Type36, Soil_Type37, Soil_Type38, Soil_Type39, Soil_Type40



```python
!jupyter nbconvert --to markdown "/gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz.ipynb"
```

    [NbConvertApp] Converting notebook /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz.ipynb to markdown
    [NbConvertApp] Support files will be in Learn-Together-with-Sarfaraz_files/
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    ...
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    [NbConvertApp] Making directory /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz_files
    [NbConvertApp] Writing 1036077 bytes to /gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz.md
...
```python
PATH = "/gdrive/'My Drive'/DataSciLab/"
```
...
```python
!cp {PATH}/.kaggle/kaggle.json "content/.kaggle/kaggle.json"
```
...
```python
!cp {PATH}/.kaggle/kaggle.json ".kaggle/kaggle.json"
```
...
```
    ...
    [NbConvertApp] WARNING | pattern u'/gdrive/My Drive/Colab Notebooks/Learn-Together-with-Sarfaraz.ipynb' matched no files
